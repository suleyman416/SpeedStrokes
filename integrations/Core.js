...
export async function InvokeLLM({ prompt }) {
  ...
  const topics = [
    ...
    "The coffee shop served tea in delicate porcelain cups.",
    ...
    "The establishment was busy, but the smell of freshly brewed coffee made the wait worthwhile. I found a seat by the window and watched the rain.",
